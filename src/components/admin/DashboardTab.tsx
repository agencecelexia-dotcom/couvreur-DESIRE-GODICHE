...
const INITIAL_SUBMISSIONS: Submission[] = [
  {
    ...
    email: "mathieu.lacroix@email.fr",
    phone: "06 12 34 56 78",
    service: "Renovation toiture",
    subject: "Rénovation toiture maison 130m2 — Boissise-le-Roi",
    message: "Bonjour, notre toiture en tuiles date des années 80 et présente des fuites importantes. Nous souhaitons un diagnostic complet et un devis pour la rénovation de notre maison.",
    location: "Boissise-le-Roi",
    date: "26/02/2026",
    time: "14:32",
    status: "Nouveau",
  },
  {
    id: "2",
    name: "Claire & Michel Renaud",
    email: "renaud.michel@gmail.com",
    phone: "06 98 76 54 32",
    service: "Isolation toiture",
    subject: "Isolation par sarking — Fontainebleau",
    message: "Nous voulons isoler notre toiture par l'extérieur pour améliorer le confort thermique. Maison de 150m2 avec combles aménageables. Pouvez-vous nous proposer un devis avec les aides possibles ?",
  ...
  },
  {
    id: "3",
    name: "Vincent Moreau",
    email: "v.moreau@orange.fr",
    phone: "07 23 45 67 89",
    service: "Zinguerie",
    subject: "Remplacement gouttières et descentes — Melun",
    message: "Les gouttières de ma maison sont oxydées et les descentes d'eaux pluviales ont des problèmes. Je souhaite un devis pour le remplacement complet en zinc de qualité.",
    location: "Melun",
    date: "24/02/2026",
    time: "16:45",
    status: "En cours",
  },
  {
    id: "4",
    name: "Sylvie Bernard",
    email: "sylvie.bernard@sfr.fr",
    phone: "06 34 56 78 90",
    service: "Demoussage & Entretien",
    subject: "Nettoyage et traitement anti-mousse — Moret-sur-Loing",
    message: "La mousse envahit notre toiture ardoise et les tuiles sont vertes. Avez-vous une solution de nettoyage avec traitement anti-mousse durable ?",
    location: "Moret-sur-Loing",
    date: "23/02/2026",
    time: "09:20",
    status: "Nouveau",
  },
  {
    ...
    email: "f.lefevre@free.fr",
    phone: "06 45 67 89 01",
    service: "Couverture neuve",
    subject: "Couverture neuve en ardoise — Nemours",
    message: "Extension de maison en cours. Nous avons besoin d'une couverture complète en ardoise naturelle pour 80m2. Quels sont vos tarifs et délais ?",
    location: "Nemours",
    date: "22/02/2026",
    time: "11:00",
    status: "Converti",
